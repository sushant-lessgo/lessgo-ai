// lib/htmlSanitizerManualTest.ts - Manual sanitization runner for /api/test-sanitization
//
// Kept OUT of htmlSanitizer.test.ts on purpose: that file imports `vitest`, and the
// /api/test-sanitization route imports this runner. Bundling a vitest import into a
// Next.js route breaks the production build. This module has no vitest dependency.
import {
...
// Manual test function (used by the /api/test-sanitization endpoint)
