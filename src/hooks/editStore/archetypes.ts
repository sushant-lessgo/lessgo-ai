...
export function buildContactSlice(formId: string): PageSlice {
  ...
  const contact = {
    ...
    data: section(cId, 'contact', 'ContactForm', {
      eyebrow: 'Contact',
      headline: 'Contact <em>us</em>.',
      lede: 'We assist the world’s leading mushroom growers in optimizing their production through advanced connectivity and automation.',
      form_id: formId,
      form_heading: 'Send us a message',
      form_note: 'Tell us about your setup and we’ll get back within one business day.',
      form_foot: 'By submitting you agree to be contacted about your enquiry.',
      whatsapp_text: 'Chat on WhatsApp',
      whatsapp_href: 'https://wa.me/919310119271',
      map_caption: 'Embedded map — Gurugram, India',
      info: [
        { id: rid('ci'), icon: 'Phone', k: 'Call / WhatsApp', v: '+91 9310119271', href: 'tel:+919310119271', sub: 'Mon–Sat, 9am–7pm IST' },
        { id: rid('ci'), icon: 'Mail', k: 'Email', v: 'info@naayom.com', href: 'mailto:info@naayom.com', sub: 'We reply within one business day' },
        { id: rid('ci'), icon: 'MapPin', k: 'Office', v: 'Gurugram, Haryana', href: '', sub: '7th Floor, Software Technology Park of India, Electronic City Phase IV, Sector 18, 122015' },
      ],
    }),
  };
