...
const CONTENT_SCHEMA = {
  ...
  secret_icon: { type: 'string' as const, default: '🔬' }
};
        ...
        <div className="bg-gradient-to-br from-purple-900 to-indigo-900 rounded-2xl p-12 text-white text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            <div className="w-20 h-20 bg-yellow-400 rounded-full flex items-center justify-center mx-auto mb-6">
              <IconEditableText
                mode={mode}
                value={blockContent.secret_icon || '🔬'}
                onEdit={(value) => handleContentUpdate('secret_icon', value)}
                backgroundType="neutral"
                colorTokens={colorTokens}
                iconSize="xl"
                className="text-purple-900 text-3xl"
                sectionId={sectionId}
                elementKey="secret_icon"
              />
            </div>
