            ...
            <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
              <div className="flex items-center text-blue-700 mb-3">
                ...
                <span className="text-sm font-medium">
                  ThreeStepHorizontal - Edit step content or click individual titles/descriptions above
                </span>
              </div>
              
              <div className="space-y-4 text-sm">
                <div>
                  <label className="block text-blue-700 font-medium mb-1">Step Titles (separated by |):</label>
                  <ModeWrapper
                    mode={mode}
                    sectionId={sectionId}
                  ...
                  >
                    <div className="bg-white p-3 rounded border text-gray-800 text-xs leading-relaxed max-h-24 overflow-y-auto">
                      {blockContent.step_titles}
                    </div>
                  </ModeWrapper>
                </div>
                
                <div>
                  <label className="block text-blue-700 font-medium mb-1">Step Descriptions (separated by |):</label>
                  <ModeWrapper
                    mode={mode}
                    sectionId={sectionId}
                ...
                <div className="text-xs text-blue-600 bg-blue-100 p-2 rounded">
                  💡 Tip: Steps are automatically numbered 1, 2, 3. Icons change based on step number. You can edit individual steps by clicking directly on them above.
                </div>
              </div>
            </div>
          </div>
