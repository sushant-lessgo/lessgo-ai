/**
 * LeftCopyRightImage Hero - Published Version
 *
 * Server-safe component with ZERO hook imports
 * Used by componentRegistry.published.ts for SSR rendering
 *
 * Layout: Two-column grid (copy left, image right on desktop)
 * Mobile: Image first, copy below (responsive order)
 *
 * Features:
 * - Two-column responsive grid layout
 * - Copy on left, image on right (desktop)
 * - Image first on mobile with order classes
 ...
 * Supports filled and empty stars
 */
...
export default function LeftCopyRightImagePublished(props: LayoutComponentProps) {
  ...
  const hero_image = props.hero_image || '/hero-placeholder.jpg';
