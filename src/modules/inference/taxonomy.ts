...
// Pricing Modifiers (Apply selectively)
...
export const awarenessLevels = [
  {
    id: 'unaware',
    label: 'Unaware',
    description: 'User doesn’t know they have a problem yet.',
  ...
  },
  {
    id: 'product-aware',
    label: 'Product-Aware',
    description: 'User knows your product but hasn’t decided.',
...
export const marketSophisticationLevels = [
  {
    ...
    description: 'You’re first to introduce a solution. Direct benefit-led copy works.',
  ...
  },
  {
    ...
    example: '“Wrinkles aren’t flaws. Join the age-positive movement.”',
  },
] as const;
