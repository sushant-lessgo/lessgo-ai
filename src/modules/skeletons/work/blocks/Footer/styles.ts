...
.wk-footer__heading{ font-family:var(--wk-ff-display); font-weight:var(--wk-display-weight); font-size:clamp(1.7rem,4vw,3rem); line-height:1.02; letter-spacing:-0.02em; margin:10px 0 0; }
