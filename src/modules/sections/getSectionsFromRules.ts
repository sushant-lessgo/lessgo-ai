// getSectionsFromRules.ts - ✅ PHASE 7: Uses intelligent asset-aware substitution
import { getSectionsFromObjectionFlows } from './objectionFlowEngine';
import { applyAssetAwareSubstitutions } from './assetSubstitutionEngine';
...
export function getSectionsFromRules({
  ...
  // ✅ PHASE 7: Apply intelligent asset-aware substitutions
  // RULE 6: Maintain objection coverage even when assets are unavailable
  ...
  logger.dev('✅ Section selection complete:', () => ({
