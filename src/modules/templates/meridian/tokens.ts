 ...
 * followed by:
 *   - `[data-meridian-surface=...]` rules → parent renderer wraps each section in
...
[data-meridian-surface="ink"]{background:var(--ink);}
[data-meridian-surface="ink-1"]{background:var(--ink-1);}
[data-meridian-surface="ink-2"]{background:var(--ink-2);}
