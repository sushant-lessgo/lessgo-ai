// Fallback rendered for any Lumen section type with no registered block. A
...
export function LumenPlaceholderBlock({ sectionId, layout }: Props) {
  return (
...
export default LumenPlaceholderBlock;
