...
.tp-gx{ align-self:flex-start; background:transparent; border:1px solid var(--line-dk); color:var(--on-dark-2); font-size:12px; padding:2px 8px; border-radius:var(--r); cursor:pointer; }
.tp-managed-hint{ margin:22px 0 0; font-family:var(--font-mono); font-size:11.5px; letter-spacing:0.02em; line-height:1.5; color:var(--on-dark-2); text-align:center; }
