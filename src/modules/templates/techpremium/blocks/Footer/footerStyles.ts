...
.tp-footer { background:var(--forest-d); color:color-mix(in oklch, var(--on-dark) 82%, transparent); font-family:var(--font-body); }
...
.tp-footer__mk { width:34px; height:34px; border-radius:7px; background:var(--forest); display:grid; place-items:center; position:relative; flex-shrink:0; }
...
.tp-footer__blurb { font-size:14px; line-height:1.7; max-width:34ch; margin:18px 0; color:color-mix(in oklch, var(--on-dark) 78%, transparent); }
...
.tp-footer__social a { width:34px; height:34px; border:1px solid var(--line-dk); border-radius:var(--r); display:grid; place-items:center; color:color-mix(in oklch, var(--on-dark) 70%, transparent); }
...
.tp-soc-pop input::placeholder { color:color-mix(in oklch, var(--on-dark) 50%, transparent); }
.tp-soc-pop select option { color:#111; }
.tp-soc-pop button { background:transparent; border:1px solid var(--line-dk); color:color-mix(in oklch, var(--on-dark) 70%, transparent); border-radius:var(--r); padding:5px 8px; cursor:pointer; font-family:var(--font-mono); font-size:11px; line-height:1; }
...
.tp-news__input::placeholder { color:color-mix(in oklch, var(--on-dark) 55%, transparent); }
