      ...
      <footer className="tp-footer">
        <div className="tp-footer__top">
          <div className="tp-footer__brand">
            <span className="tp-footer__brand-wm">{props.logo_image ? <img className="tp-footer__img" src={props.logo_image} alt={props.wordmark || 'Logo'} loading="lazy" decoding="async" /> : <><span className="tp-footer__mk" aria-hidden="true" />{props.wordmark || ''}</>}</span>
