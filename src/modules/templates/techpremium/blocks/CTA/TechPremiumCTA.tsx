...
.tp-cta__body { font-family:var(--font-body); font-size:17px; line-height:1.7; color:color-mix(in oklch, var(--on-dark) 82%, transparent); max-width:46ch; margin:0; }
...
.tp-cta__phone { font-family:var(--font-mono); font-size:12.5px; letter-spacing:0.04em; color:color-mix(in oklch, var(--on-dark) 78%, transparent); margin:14px 0 0; }
