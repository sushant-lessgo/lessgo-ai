// Fallback rendered for any Surge section type with no registered block. A
...
export function SurgePlaceholderBlock({ sectionId, layout }: Props) {
  return (
...
export default SurgePlaceholderBlock;
