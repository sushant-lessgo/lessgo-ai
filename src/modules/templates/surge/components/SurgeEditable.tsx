...
// src/modules/templates/surge/components/SurgeEditable.tsx
// Minimal contenteditable wrapper for Surge blocks. Wraps InlineTextEditorV2 in
// `edit` mode (preserves <em> via preserveHtml=true); renders raw HTML in
...
interface SurgeEditableProps {
   ...
   * and a double click enters text editing. Scope narrowly to actual button/CTA
   * elements — every other Surge text element must keep single-click-to-edit.
   */
  isButton?: boolean;
}

export function SurgeEditable({
  value,
  mode,
  sectionId,
  elementKey,
