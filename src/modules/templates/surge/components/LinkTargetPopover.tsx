...
// src/modules/templates/surge/components/LinkTargetPopover.tsx
// Inline editor control for setting a nav/footer link's target. Two/three modes:
...
// Surge copy of the naayom LinkTargetPopover (generic; no template tokens). Kept
// self-contained per-template (avoids cross-template import). Edit mode only —
