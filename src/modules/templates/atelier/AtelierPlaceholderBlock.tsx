// Fallback rendered for any Atelier section type with no registered block. A
...
export function AtelierPlaceholderBlock({ sectionId, layout }: Props) {
  return (
...
export default AtelierPlaceholderBlock;
