...
- phase 8 trust engine through unified wizard: done (commit pending-sha, review loops 1, ship — 543 tests, tsc clean; +GeneratingSlot per-engine fix authorized; trust end-to-end)
