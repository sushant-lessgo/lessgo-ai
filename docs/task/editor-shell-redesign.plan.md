...
8. **`UserButton` (Clerk) STAYS** in the right cluster — it is the ONLY sign-out path; dropping it = behavior change. Deliberate deviation from t1 (no avatar slot drawn) — flag to founder at phase-4 gate.
