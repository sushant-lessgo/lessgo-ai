...
- phase 7 reserved-slug hardening + asset-base regression guard: done (commit 1357658c, review loops 1)
- phase 8 HUMAN GATE — slice-2 live verify: AWAITING USER (all code phases done; final build green)
