...
- phase 4 failure telemetry (PostHog): done (review loops 1, ship; message-signature parse/generation split, reason carries true code; credit-fails excluded; hostname-only privacy; commit 9870ca72)
