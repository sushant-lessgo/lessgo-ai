...
- phase 1 debug strip & gate: done (review loops 1, ship; non-blocking: harmless dead-undo-step in unreachable itemId-not-found path, 1 residual plan-compliant logger.debug)
- phase 2 autosave event-driven debounce: pending
