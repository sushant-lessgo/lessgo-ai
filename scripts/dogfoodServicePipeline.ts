...
const PERSONAS: DogfoodPersona[] = [
  ...
  },
  {
    ...
    understanding: {
      serviceType: 'agency',
      whatYouDo: 'Conversion-focused landing page agency for B2B SaaS companies',
      targetClients: ['Series A–B SaaS marketing leads owning the website'],
      outcomes: ['Higher demo conversion', 'CRO-backed design decisions', 'Webflow handoff in 2 weeks'],
  ...
  },
  {
    ...
    understanding: {
      serviceType: 'agency',
      whatYouDo: 'Local marketing agency helping independent restaurants fill seats midweek',
      targetClients: ['Owner-operators of independent restaurants in major US metros'],
      outcomes: ['More midweek covers', 'Top-3 local map rankings', 'Done-for-you content'],
  ...
  },
  {
    ...
    understanding: {
      serviceType: 'agency',
      whatYouDo: 'Web design agency exclusively for boutique law firms',
      targetClients: ['Managing partners of 5–25 attorney firms in the US'],
      outcomes: ['Compliance-safe copy', 'More qualified case inquiries', 'Senior-only delivery'],
  ...
  },
  {
    ...
    understanding: {
      serviceType: 'agency',
      whatYouDo: 'UX consultancy turning wellness-clinic visitors into booked appointments',
      targetClients: ['Multi-location wellness clinic owners and clinical leads'],
      outcomes: ['More booked appointments', 'Research-backed booking flow', 'Faster path to book'],
  ...
  // Phase 8: consultant + coach personas (newly unlocked) for the case matrix.
  {
    ...
    understanding: {
      ...
      whatYouDo: 'Independent operations consultant fixing internal chaos at scaling startups',
      targetClients: ['Founders and COOs of 10–80 person startups feeling operational drag'],
      outcomes: ['Calmer operations in 90 days', 'Documented processes', 'Right tooling stack'],
  ...
  },
  {
    ...
    understanding: {
      ...
      whatYouDo: 'Leadership coach for newly-promoted engineering managers stepping into their first director role',
      targetClients: ['First-time directors and senior managers at growth-stage tech companies'],
      outcomes: ['Confident first-time directors', 'Stronger leadership presence', 'Actionable 360 feedback'],
...
function detectCredibilityHallucination(
  ...
  const corpus = [
    persona.oneLiner,
    persona.offer,
    persona.understanding.whatYouDo,
    ...persona.understanding.targetClients,
    ...persona.understanding.outcomes,
