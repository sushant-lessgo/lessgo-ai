...
Why?  
1. Controller helps you to manage the components and its states (you can see a live example on my t.co/C5cOdmvOUe UI library and check any component preview - that uses the same method, where you can change any prop value live, this is dynamic and work for all components).
